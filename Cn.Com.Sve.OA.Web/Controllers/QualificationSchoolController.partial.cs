...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class QualificationSchoolController : BaseController {
    	partial void BeforeGetData(QualificationSchoolCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, QualificationSchool e);
    	partial void AfterGetData(LigerGridModel gm, QualificationSchoolCriteria c, PagedModel<QualificationSchool> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, QualificationSchoolCriteria c, PagedModel<QualificationSchool> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(QualificationSchool e, ref ActionResult ar);
    	partial void AfterAddData(QualificationSchool e, ref ActionResult ar);
    	partial void BeforeShowEditView(QualificationSchool e);
    	partial void BeforeUpdateData(QualificationSchool e, ref ActionResult ar);
    	...
    	public IQualificationSchoolService Service { get; set; }
    	public QualificationSchoolController() {
    		this.Service = new QualificationSchoolService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(QualificationSchoolCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(QualificationSchool e) {
    	...
    	[HttpPost]
    	public ActionResult Update(QualificationSchool e) {
    		ActionResult ar = null;
    		try {
