...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class SchoolContactController : BaseController {
    	...
    	partial void BeforeAddData(SchoolContact e, ref ActionResult ar);
    	...
    	public ISchoolContactService Service { get; set; }
    	public SchoolContactController() {
    		this.Service = new SchoolContactService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(SchoolContactCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Update(SchoolContact e) {
    		ActionResult ar = null;
    		try {
