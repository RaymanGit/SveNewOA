...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class EmploymentCompanyContactController : BaseController {
    	partial void BeforeGetData(EmploymentCompanyContactCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, EmploymentCompanyContact e);
    	partial void AfterGetData(LigerGridModel gm, EmploymentCompanyContactCriteria c, PagedModel<EmploymentCompanyContact> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, EmploymentCompanyContactCriteria c, PagedModel<EmploymentCompanyContact> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(EmploymentCompanyContact e, ref ActionResult ar);
    	partial void AfterAddData(EmploymentCompanyContact e, ref ActionResult ar);
    	partial void BeforeShowEditView(EmploymentCompanyContact e);
    	partial void BeforeUpdateData(EmploymentCompanyContact e, ref ActionResult ar);
    	...
    	public IEmploymentCompanyContactService Service { get; set; }
    	public EmploymentCompanyContactController() {
    		this.Service = new EmploymentCompanyContactService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(EmploymentCompanyContactCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(EmploymentCompanyContact e) {
    	...
    	[HttpPost]
    	public ActionResult Update(EmploymentCompanyContact e) {
    		ActionResult ar = null;
    		try {
