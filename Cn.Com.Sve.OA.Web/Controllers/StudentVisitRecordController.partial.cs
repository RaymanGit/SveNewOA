...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class StudentVisitRecordController : BaseController {
    	partial void BeforeGetData(StudentVisitRecordCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, StudentVisitRecord e);
    	partial void AfterGetData(LigerGridModel gm, StudentVisitRecordCriteria c, PagedModel<StudentVisitRecord> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, StudentVisitRecordCriteria c, PagedModel<StudentVisitRecord> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(StudentVisitRecord e, ref ActionResult ar);
    	partial void AfterAddData(StudentVisitRecord e, ref ActionResult ar);
    	partial void BeforeShowEditView(StudentVisitRecord e);
    	partial void BeforeUpdateData(StudentVisitRecord e, ref ActionResult ar);
    	...
    	public IStudentVisitRecordService Service { get; set; }
    	public StudentVisitRecordController() {
    		this.Service = new StudentVisitRecordService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(StudentVisitRecordCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(StudentVisitRecord e) {
    	...
    	[HttpPost]
    	public ActionResult Update(StudentVisitRecord e) {
    		ActionResult ar = null;
    		try {
