...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class BigInfoSourceController : BaseController {
    	partial void BeforeGetData(BigInfoSourceCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, BigInfoSource e);
    	partial void AfterGetData(LigerGridModel gm, BigInfoSourceCriteria c, PagedModel<BigInfoSource> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, BigInfoSourceCriteria c, PagedModel<BigInfoSource> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(BigInfoSource e, ref ActionResult ar);
    	partial void AfterAddData(BigInfoSource e, ref ActionResult ar);
    	partial void BeforeShowEditView(BigInfoSource e);
    	partial void BeforeUpdateData(BigInfoSource e, ref ActionResult ar);
    	...
    	public IBigInfoSourceService Service { get; set; }
    	public BigInfoSourceController() {
    		this.Service = new BigInfoSourceService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(BigInfoSourceCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(BigInfoSource e) {
    	...
    	[HttpPost]
    	public ActionResult Update(BigInfoSource e) {
    		ActionResult ar = null;
    		try {
