...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class UserGroupModulePermissionController : BaseController {
    	partial void BeforeGetData(UserGroupModulePermissionCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, UserGroupModulePermission e);
    	partial void AfterGetData(LigerGridModel gm, UserGroupModulePermissionCriteria c, PagedModel<UserGroupModulePermission> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, UserGroupModulePermissionCriteria c, PagedModel<UserGroupModulePermission> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(UserGroupModulePermission e, ref ActionResult ar);
    	partial void AfterAddData(UserGroupModulePermission e, ref ActionResult ar);
    	partial void BeforeShowEditView(UserGroupModulePermission e);
    	partial void BeforeUpdateData(UserGroupModulePermission e, ref ActionResult ar);
    	...
    	public IUserGroupModulePermissionService Service { get; set; }
    	public UserGroupModulePermissionController() {
    		this.Service = new UserGroupModulePermissionService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(UserGroupModulePermissionCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(UserGroupModulePermission e) {
    	...
    	[HttpPost]
    	public ActionResult Update(UserGroupModulePermission e) {
    		ActionResult ar = null;
    		try {
