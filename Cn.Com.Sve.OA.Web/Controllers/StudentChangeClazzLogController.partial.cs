...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class StudentChangeClazzLogController : BaseController {
    	partial void BeforeGetData(StudentChangeClazzLogCriteria c);
    	...
    	partial void AfterBuildGridModel(LigerGridModel gm, StudentChangeClazzLogCriteria c, PagedModel<StudentChangeClazzLog> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(StudentChangeClazzLog e, ref ActionResult ar);
    	partial void AfterAddData(StudentChangeClazzLog e, ref ActionResult ar);
    	partial void BeforeShowEditView(StudentChangeClazzLog e);
    	partial void BeforeUpdateData(StudentChangeClazzLog e, ref ActionResult ar);
    	...
    	public IStudentChangeClazzLogService Service { get; set; }
    	public StudentChangeClazzLogController() {
    		this.Service = new StudentChangeClazzLogService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(StudentChangeClazzLogCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(StudentChangeClazzLog e) {
    	...
    	[HttpPost]
    	public ActionResult Update(StudentChangeClazzLog e) {
    		ActionResult ar = null;
    		try {
