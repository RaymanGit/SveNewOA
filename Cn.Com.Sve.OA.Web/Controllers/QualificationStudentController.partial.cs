...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class QualificationStudentController : BaseController {
    	partial void BeforeGetData(QualificationStudentCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, QualificationStudent e);
    	partial void AfterGetData(LigerGridModel gm, QualificationStudentCriteria c, PagedModel<QualificationStudent> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, QualificationStudentCriteria c, PagedModel<QualificationStudent> pm);
    	...
    	partial void BeforeShowEditView(QualificationStudent e);
    	...
    	public IQualificationStudentService Service { get; set; }
    	public QualificationStudentController() {
    		this.Service = new QualificationStudentService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(QualificationStudentCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(QualificationStudent e) {
    	...
    	[HttpPost]
    	public ActionResult Update(QualificationStudent e) {
    		ActionResult ar = null;
    		try {
