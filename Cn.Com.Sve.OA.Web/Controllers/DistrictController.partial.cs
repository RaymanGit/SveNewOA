...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class DistrictController : BaseController {
    	partial void BeforeGetData(DistrictCriteria c);
    	...
    	public IDistrictService Service { get; set; }
    	public DistrictController() {
    		this.Service = new DistrictService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(DistrictCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Update(District e) {
    		ActionResult ar = null;
    		try {
