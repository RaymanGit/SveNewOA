...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class ModuleController : BaseController {
    	partial void BeforeGetData(ModuleCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, Module e);
    	partial void AfterGetData(LigerGridModel gm, ModuleCriteria c, PagedModel<Module> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, ModuleCriteria c, PagedModel<Module> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(Module e, ref ActionResult ar);
    	partial void AfterAddData(Module e, ref ActionResult ar);
    	partial void BeforeShowEditView(Module e);
    	partial void BeforeUpdateData(Module e, ref ActionResult ar);
    	...
    	public ModuleController() {
    		this.Service = new ModuleService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(ModuleCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(Module e) {
    	...
    	[HttpPost]
    	public ActionResult Update(Module e) {
    		ActionResult ar = null;
    		try {
