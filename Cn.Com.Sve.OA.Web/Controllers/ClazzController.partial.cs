...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class ClazzController : BaseController {
    	...
    	public IClazzService Service { get; set; }
    	public ClazzController() {
    		this.Service = new ClazzService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(ClazzCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Update(Clazz e) {
    		ActionResult ar = null;
    		try {
