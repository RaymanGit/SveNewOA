...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class UserController : BaseController {
    	partial void BeforeGetData(UserCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, User e);
    	partial void AfterGetData(LigerGridModel gm, UserCriteria c, PagedModel<User> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, UserCriteria c, PagedModel<User> pm);
    	...
    	partial void BeforeShowEditView(User e);
    	...
    	public UserController() {
    		this.Service = new UserService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(UserCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(User e) {
    	...
    	[HttpPost]
    	public ActionResult Update(User e) {
    		ActionResult ar = null;
    		try {
