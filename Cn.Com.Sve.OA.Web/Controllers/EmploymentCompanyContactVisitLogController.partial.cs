...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class EmploymentCompanyContactVisitLogController : BaseController {
    	partial void BeforeGetData(EmploymentCompanyContactVisitLogCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, EmploymentCompanyContactVisitLog e);
    	partial void AfterGetData(LigerGridModel gm, EmploymentCompanyContactVisitLogCriteria c, PagedModel<EmploymentCompanyContactVisitLog> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, EmploymentCompanyContactVisitLogCriteria c, PagedModel<EmploymentCompanyContactVisitLog> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(EmploymentCompanyContactVisitLog e, ref ActionResult ar);
    	partial void AfterAddData(EmploymentCompanyContactVisitLog e, ref ActionResult ar);
    	partial void BeforeShowEditView(EmploymentCompanyContactVisitLog e);
    	partial void BeforeUpdateData(EmploymentCompanyContactVisitLog e, ref ActionResult ar);
    	...
    	public IEmploymentCompanyContactVisitLogService Service { get; set; }
    	public EmploymentCompanyContactVisitLogController() {
    		this.Service = new EmploymentCompanyContactVisitLogService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(EmploymentCompanyContactVisitLogCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(EmploymentCompanyContactVisitLog e) {
    	...
    	[HttpPost]
    	public ActionResult Update(EmploymentCompanyContactVisitLog e) {
    		ActionResult ar = null;
    		try {
