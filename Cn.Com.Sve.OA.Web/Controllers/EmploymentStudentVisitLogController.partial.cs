...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class EmploymentStudentVisitLogController : BaseController {
    	...
    	partial void AfterBuildGridModel(LigerGridModel gm, EmploymentStudentVisitLogCriteria c, PagedModel<EmploymentStudentVisitLog> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(EmploymentStudentVisitLog e, ref ActionResult ar);
    	...
    	public IEmploymentStudentVisitLogService Service { get; set; }
    	public EmploymentStudentVisitLogController() {
    		this.Service = new EmploymentStudentVisitLogService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(EmploymentStudentVisitLogCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Update(EmploymentStudentVisitLog e) {
    		ActionResult ar = null;
    		try {
