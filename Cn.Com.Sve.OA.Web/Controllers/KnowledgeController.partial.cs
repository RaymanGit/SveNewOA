...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class KnowledgeController : BaseController {
    	partial void BeforeGetData(KnowledgeCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, Knowledge e);
    	partial void AfterGetData(LigerGridModel gm, KnowledgeCriteria c, PagedModel<Knowledge> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, KnowledgeCriteria c, PagedModel<Knowledge> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(Knowledge e, ref ActionResult ar);
    	partial void AfterAddData(Knowledge e, ref ActionResult ar);
    	partial void BeforeShowEditView(Knowledge e);
    	partial void BeforeUpdateData(Knowledge e, ref ActionResult ar);
    	...
    	public IKnowledgeService Service { get; set; }
    	public KnowledgeController() {
    		this.Service = new KnowledgeService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(KnowledgeCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(Knowledge e) {
    	...
    	[HttpPost]
    	public ActionResult Update(Knowledge e) {
    		ActionResult ar = null;
    		try {
