...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class SupervisorController : BaseController {
    	partial void BeforeGetData(SupervisorCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, Supervisor e);
    	partial void AfterGetData(LigerGridModel gm, SupervisorCriteria c, PagedModel<Supervisor> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, SupervisorCriteria c, PagedModel<Supervisor> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(Supervisor e, ref ActionResult ar);
    	partial void AfterAddData(Supervisor e, ref ActionResult ar);
    	partial void BeforeShowEditView(Supervisor e);
    	partial void BeforeUpdateData(Supervisor e, ref ActionResult ar);
    	...
    	public SupervisorController() {
    		this.Service = new SupervisorService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(SupervisorCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(Supervisor e) {
    	...
    	[HttpPost]
    	public ActionResult Update(Supervisor e) {
    		ActionResult ar = null;
    		try {
