...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class CityController : BaseController {
    	partial void BeforeGetData(CityCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, City e);
    	partial void AfterGetData(LigerGridModel gm, CityCriteria c, PagedModel<City> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, CityCriteria c, PagedModel<City> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(City e, ref ActionResult ar);
    	partial void AfterAddData(City e, ref ActionResult ar);
    	partial void BeforeShowEditView(City e);
    	partial void BeforeUpdateData(City e, ref ActionResult ar);
    	...
    	public CityController() {
    		this.Service = new CityService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(CityCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(City e) {
    	...
    	[HttpPost]
    	public ActionResult Update(City e) {
    		ActionResult ar = null;
    		try {
