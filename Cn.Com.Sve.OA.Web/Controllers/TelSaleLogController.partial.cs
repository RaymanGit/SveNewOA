...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class TelSaleLogController : BaseController {
    	partial void BeforeGetData(TelSaleLogCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, TelSaleLog e);
    	partial void AfterGetData(LigerGridModel gm, TelSaleLogCriteria c, PagedModel<TelSaleLog> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, TelSaleLogCriteria c, PagedModel<TelSaleLog> pm);
    	...
    	partial void BeforeShowEditView(TelSaleLog e);
    	...
    	public ITelSaleLogService Service { get; set; }
    	public TelSaleLogController() {
    		this.Service = new TelSaleLogService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(TelSaleLogCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(TelSaleLog e) {
    	...
    	[HttpPost]
    	public ActionResult Update(TelSaleLog e) {
    		ActionResult ar = null;
    		try {
