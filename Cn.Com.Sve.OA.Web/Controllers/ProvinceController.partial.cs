...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class ProvinceController : BaseController {
    	partial void BeforeGetData(ProvinceCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, Province e);
    	partial void AfterGetData(LigerGridModel gm, ProvinceCriteria c, PagedModel<Province> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, ProvinceCriteria c, PagedModel<Province> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(Province e, ref ActionResult ar);
    	partial void AfterAddData(Province e, ref ActionResult ar);
    	partial void BeforeShowEditView(Province e);
    	partial void BeforeUpdateData(Province e, ref ActionResult ar);
    	partial void AfterUpdateData(Province e, ref ActionResult ar);
    	partial void BeforeDeleteData(int id, ref ActionResult ar);
    	partial void AfterDeleteData(int id, ref ActionResult ar);
    
    	public IProvinceService Service { get; set; }
    	public ProvinceController() {
    		this.Service = new ProvinceService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(ProvinceCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Update(Province e) {
    		ActionResult ar = null;
    		try {
