...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class StudentTeleVisitRecordController : BaseController {
    	...
    	partial void AfterBuildGridModel(LigerGridModel gm, StudentTeleVisitRecordCriteria c, PagedModel<StudentTeleVisitRecord> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(StudentTeleVisitRecord e, ref ActionResult ar);
    	...
    	public IStudentTeleVisitRecordService Service { get; set; }
    	public StudentTeleVisitRecordController() {
    		this.Service = new StudentTeleVisitRecordService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(StudentTeleVisitRecordCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Update(StudentTeleVisitRecord e) {
    		ActionResult ar = null;
    		try {
