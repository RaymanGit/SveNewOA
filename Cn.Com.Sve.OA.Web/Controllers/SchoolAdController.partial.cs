...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class SchoolAdController : BaseController {
    	partial void BeforeGetData(SchoolAdCriteria c);
    	...
    	public ISchoolAdService Service { get; set; }
    	public SchoolAdController() {
    		this.Service = new SchoolAdService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(SchoolAdCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Update(SchoolAd e) {
    		ActionResult ar = null;
    		try {
