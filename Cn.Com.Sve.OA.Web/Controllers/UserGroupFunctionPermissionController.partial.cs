...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class UserGroupFunctionPermissionController : BaseController {
    	partial void BeforeGetData(UserGroupFunctionPermissionCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, UserGroupFunctionPermission e);
    	partial void AfterGetData(LigerGridModel gm, UserGroupFunctionPermissionCriteria c, PagedModel<UserGroupFunctionPermission> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, UserGroupFunctionPermissionCriteria c, PagedModel<UserGroupFunctionPermission> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(UserGroupFunctionPermission e, ref ActionResult ar);
    	partial void AfterAddData(UserGroupFunctionPermission e, ref ActionResult ar);
    	partial void BeforeShowEditView(UserGroupFunctionPermission e);
    	partial void BeforeUpdateData(UserGroupFunctionPermission e, ref ActionResult ar);
    	...
    	public IUserGroupFunctionPermissionService Service { get; set; }
    	public UserGroupFunctionPermissionController() {
    		this.Service = new UserGroupFunctionPermissionService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(UserGroupFunctionPermissionCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(UserGroupFunctionPermission e) {
    	...
    	[HttpPost]
    	public ActionResult Update(UserGroupFunctionPermission e) {
    		ActionResult ar = null;
    		try {
