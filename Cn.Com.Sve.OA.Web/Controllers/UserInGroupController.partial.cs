...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class UserInGroupController : BaseController {
    	...
    	partial void BeforeAddData(UserInGroup e, ref ActionResult ar);
    	partial void AfterAddData(UserInGroup e, ref ActionResult ar);
    	partial void BeforeShowEditView(UserInGroup e);
    	partial void BeforeUpdateData(UserInGroup e, ref ActionResult ar);
    	...
    	public IUserInGroupService Service { get; set; }
    	public UserInGroupController() {
    		this.Service = new UserInGroupService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	[HttpPost]
    	public ActionResult Add(UserInGroup e) {
    	...
    	[HttpPost]
    	public ActionResult Update(UserInGroup e) {
    		ActionResult ar = null;
    		try {
