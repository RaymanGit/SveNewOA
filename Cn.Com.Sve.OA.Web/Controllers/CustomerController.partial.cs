...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class CustomerController : BaseController {
    	partial void BeforeGetData(CustomerCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, Customer e);
    	partial void AfterGetData(LigerGridModel gm, CustomerCriteria c, PagedModel<Customer> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, CustomerCriteria c, PagedModel<Customer> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(Customer e, ref ActionResult ar);
    	partial void AfterAddData(Customer e, ref ActionResult ar);
    	partial void BeforeShowEditView(Customer e);
    	partial void BeforeUpdateData(Customer e, ref ActionResult ar);
    	...
    	public CustomerController() {
    		this.Service = new CustomerService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(CustomerCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Add(Customer e) {
    	...
    	[HttpPost]
    	public ActionResult Update(Customer e) {
    		ActionResult ar = null;
    		try {
