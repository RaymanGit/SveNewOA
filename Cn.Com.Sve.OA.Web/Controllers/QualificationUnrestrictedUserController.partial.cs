...
namespace Cn.Com.Sve.OA.Web.Controllers {
    public partial class QualificationUnrestrictedUserController : BaseController {
    	partial void BeforeGetData(QualificationUnrestrictedUserCriteria c);
    	partial void AddRowToGridModel(LigerGridModel m, QualificationUnrestrictedUser e);
    	partial void AfterGetData(LigerGridModel gm, QualificationUnrestrictedUserCriteria c, PagedModel<QualificationUnrestrictedUser> pm);
    	partial void AfterBuildGridModel(LigerGridModel gm, QualificationUnrestrictedUserCriteria c, PagedModel<QualificationUnrestrictedUser> pm);
    	partial void BeforeShowAddView();
    	partial void BeforeAddData(QualificationUnrestrictedUser e, ref ActionResult ar);
    	...
    	public IQualificationUnrestrictedUserService Service { get; set; }
    	public QualificationUnrestrictedUserController() {
    		this.Service = new QualificationUnrestrictedUserService(new SysContext{ CurrentUser = AppContext.CurrentUser });
    	}
    	...
    	public ActionResult GetData(QualificationUnrestrictedUserCriteria c) {
    	...
    	[HttpPost]
    	public ActionResult Update(QualificationUnrestrictedUser e) {
    		ActionResult ar = null;
    		try {
