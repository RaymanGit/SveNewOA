...
{
    public partial class StudentVisitRecord
    {
        ...
        {
            if (previousValue != null && previousValue.Student_VisitRecord.Contains(this))
            {
                previousValue.Student_VisitRecord.Remove(this);
            }
    
            if (Clazz != null)
            {
                if (!Clazz.Student_VisitRecord.Contains(this))
                {
                    Clazz.Student_VisitRecord.Add(this);
                }
                if (ClazzId != Clazz.Id)
                {
                    ClazzId = Clazz.Id;
        ...
        {
            if (previousValue != null && previousValue.VisitRecords.Contains(this))
            {
                previousValue.VisitRecords.Remove(this);
            }
    
            if (Student != null)
            {
                if (!Student.VisitRecords.Contains(this))
                {
                    Student.VisitRecords.Add(this);
                }
        ...
        private void FixupReviewer(User previousValue)
        {
            ...
            if (Reviewer != null)
            {
                if (!Reviewer.Student_VisitRecord.Contains(this))
                {
                    Reviewer.Student_VisitRecord.Add(this);
                }
        ...
        {
            if (previousValue != null && previousValue.Student_VisitRecord1.Contains(this))
            {
                previousValue.Student_VisitRecord1.Remove(this);
            }
    
            if (Visitor != null)
            {
                if (!Visitor.Student_VisitRecord1.Contains(this))
                {
                    Visitor.Student_VisitRecord1.Add(this);
                }
